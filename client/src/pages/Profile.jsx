...
import { getAllOrders, getMyOrder } from "../feature/order/orderSlice";
import { toast } from "react-toastify";
import Loder from "../components/Loder";
import OrderDetailsModal from "../components/OrderDetailsModel"
import CanceOrderModal from "../components/CancleOrderModel"
...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        if (orderError && orderErrorMessage) {
            toast.error(orderErrorMessage, { position: "top-center" })
        }
    ...
    return (
        <div className="min-h-screen mt-14 bg-gray-50 ">
            ...
            <div className={showOrder || showCancelOrder ? 'blur-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'}>
