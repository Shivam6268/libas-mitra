...
import { addProductReview } from "../feature/products/productSlice";

const AddReviews = ({ pid }) => {
    ...
    const handelSubmitReview = (e) => {
        ...
        dispatch(addProductReview({_id : pid, text, rating}))
    ...
    return (
        <section className="rounded-3xl border border-slate-100 bg-white my-10 mx-14 p-8 shadow-sm">
            ...
            <form className="space-y-6" onSubmit={handelSubmitReview}>
