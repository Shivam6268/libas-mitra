...
import { orderCancel } from '../feature/order/orderSlice'
import { toast } from 'react-toastify'

const CancleOrder = ({ handleCancelOrder, cancelOrderId }) => {
    ...
    return (
        <div className="mt-10 bg-white shadow-lg rounded-2xl shadow-md p-6 mb-12">
            <div className="max-w-md mt-10 mx-auto text-center">
